...
import org.apache.flink.runtime.jobmaster.CheckpointResourcesCleanupRunner;
...
public abstract class Dispatcher extends PermanentlyFencedRpcEndpoint<DispatcherId>
    ...
    private Dispatcher(
        ...
        this.metricServiceQueryAddress = checkNotNull(metricServiceQueryAddress);
    ...
    JobManagerRunner initializeCheckpointJobDataCleanupRunner(JobResult jobResult)
            throws Exception {
    ...
    public CompletableFuture<JobResult> requestJobResult(JobID jobId, Time timeout) {
        JobManagerRunner job = jobManagerRunnerRegistry.get(jobId);
        ...
        switch (cleanupJobState) {
            ...
            case GLOBAL:
                return globalResourceCleaner
                        .cleanupAsync(jobId)
                        .thenRun(() -> cleanUpJobResult(jobId));
            default:
    ...
    private Optional<JobManagerRunner> getJobManagerRunner(JobID jobId) {
        return Optional.ofNullable(jobManagerRunnerRegistry.get(jobId));
    }
