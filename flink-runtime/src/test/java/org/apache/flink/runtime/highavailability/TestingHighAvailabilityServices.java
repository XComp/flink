...
public class TestingHighAvailabilityServices implements HighAvailabilityServices {
    ...
    private ConcurrentHashMap<JobID, LeaderElection> jobManagerLeaderElectionServices =
            new ConcurrentHashMap<>();
    ...
    public void setJobMasterLeaderElectionService(JobID jobID, LeaderElection leaderElection) {
        this.jobManagerLeaderElectionServices.put(jobID, leaderElection);
    }
