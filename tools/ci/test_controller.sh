...
if [ $STAGE == $STAGE_PYTHON ]; then
	...
	run_with_watchdog "run_mvn $MVN_COMMON_OPTIONS $MVN_TEST_OPTIONS $PROFILE $MVN_TEST_MODULES verify -Dtest=org.apache.flink.connectors.hive.HiveDialectQueryITCase,org.apache.flink.connectors.hive.HiveDialectQueryITCase,org.apache.flink.connectors.hive.HiveDialectQueryITCase" $CALLBACK_ON_TIMEOUT
	EXIT_CODE=$?
fi
